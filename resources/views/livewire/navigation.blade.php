...
?>
<nav x-data="{ open: @entangle('open') }" class="w-full relative flex items-center justify-between flex-wrap bg-[#00A2E5] p-2 mb-6">
  ...
  <div class="absolute top-0 right-5 p-2" style="height:inherit;">
    <div class="flex items-center gap-3">
      <div class="mt-[2px]">
        <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white lg:mt-0">
          {{$this->user}}
        </a>
      </div>
      <div class="block lg:hidden">
        <button @click="open = !open" class="flex items-center px-2 py-1 border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white">
